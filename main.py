...
s_box = (
    ...
    0x16,)
inv_s_box = (0x52, 0x09, 0x6A, 0xD5, 0x30, 0x36, 0xA5, 0x38, 0xBF, 0x40, 0xA3, 0x9E, 0x81, 0xF3, 0xD7,
...
def encrypt(key, plaintext, workload=100000):
    ...
    if isinstance(plaintext, str):
        ...
        ciphertext = AES(key).encrypt_cbc(plaintext, key)
        return ciphertext


def decrypt(key, ciphertext, workload=100000):
    return AES(key).decrypt_cbc(ciphertext, key)
...
if __name__ == '__main__':
    ...
    file1.close()
    symmetric_key = input("Enter symmetric key: ")
    print(symmetric_key)
    cipher_text = encrypt(symmetric_key, input_text)
